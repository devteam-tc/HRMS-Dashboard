...
import { Plus, Users, Briefcase, Hourglass, CalendarCheck, Calendar, FileText } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="neu-small p-6 rounded-2xl">
            <div className="flex items-center justify-between mb-2">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#EF5226' }}>
                <Users className="w-6 h-6 text-white" />
              </div>
              <div className="text-3xl font-bold text-[#333333]">24</div>
            </div>
            <div className="text-sm text-[#666666]">Total Onboardings</div>
          </div>

          {/* Active Onboardings */}
          <div className="neu-small p-6 rounded-2xl">
            <div className="flex items-center justify-between mb-2">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#05A7CC' }}>
                <Briefcase className="w-6 h-6 text-white" />
              </div>
              <div className="text-3xl font-bold text-[#333333]">8</div>
            </div>
            <div className="text-sm text-[#666666]">Active Onboardings</div>
          </div>

          {/* Pending Onboardings */}
          <div className="neu-small p-6 rounded-2xl">
            <div className="flex items-center justify-between mb-2">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#F7C948' }}>
                <Hourglass className="w-6 h-6 text-white" />
              </div>
              <div className="text-3xl font-bold text-[#333333]">5</div>
            </div>
            <div className="text-sm text-[#666666]">Pending Onboardings</div>
          </div>

          {/* Today's Onboardings */}
          <div className="neu-small p-6 rounded-2xl">
            <div className="flex items-center justify-between mb-2">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#6FCF97' }}>
                <CalendarCheck className="w-6 h-6 text-white" />
              </div>
              <div className="text-3xl font-bold text-[#333333]">3</div>
            </div>
            <div className="text-sm text-[#666666]">Today’s Onboardings</div>
          </div>
        </div>
      </div>
