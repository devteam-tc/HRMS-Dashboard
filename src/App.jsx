...
import AllProjectsGrid from './components/dashboard/vlsm/all-project';
import { VSLMAnalytics } from './components/dashboard/vlsm/analytics';
import TaskDependencies from './components/dashboard/vlsm/dependencies';
import ProjectDetails from './components/dashboard/vlsm/new-project';
import ProjectEdit from './components/dashboard/vlsm/project-edit';
import AllProjectsList from './components/dashboard/vlsm/project-list';
import TaskReports from './components/dashboard/vlsm/reports';
import SubtasksManagement from './components/dashboard/vlsm/subtasks';
import TaskAssignment from './components/dashboard/vlsm/taskassignment';
import TaskDetails from './components/dashboard/vlsm/taskdetails';
// import TaskTimeline, { ProjectTimeline } from './components/dashboard/vlsm/timeline';
import { UploadedImages } from './components/dashboard/vlsm/uploaded-images';
import { ProjectTimeline } from './components/dashboard/vlsm/timeline';
import { SiteVisitLog } from './components/dashboard/vlsm/sitevisitlog';
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-gray-50 p-4">
          <Routes>
            ...
            <Route path="/all-project" element={<AllProjectsGrid />} />
            <Route path="/uploaded-images" element={<UploadedImages />} />
            <Route path="/analytics" element={<VSLMAnalytics />} />
            <Route path="/sitevisitlog" element={<SiteVisitLog />} />
